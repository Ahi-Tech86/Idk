...
public class UserPasswordController {
    ...
    public String sendCode(@RequestBody PasswordResetRequest request) {
        service.sendPasswordResetCode(request);

        return "An reset password code has been sent to your email, please send the reset password code before it expires. " +
    ...
    public String confirmResetPassword(@RequestBody PasswordResetConfirmRequest request) {
        ...
        return "Your password was successfully reset and created new";
    }
}
